...
def add():
    ...
    add_description_entry.grid(row=4, column=1, padx=5, pady=5, sticky=NW)
...
data_label = Label(ventana, text="Creado por Víctor Robles Web")
...
add_description_entry = Text(add_frame, height=5, width=25)
